	...
	<script type="text/javascript">
	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table', 'laydate'], function() {
			...
			tableIns=table.render({
				 elem: '#borrowTable'
			    //,url:'${ctx}/borrow/queryAllBorrowByRid.action'
			    ,title: '借阅信息数据表'
			    ...
			    ,cols: [[
			      ...
			      ,{fixed: 'right', title:'操作', toolbar: '#borrowBar', width:120,align:'center'}
			    ]]
			})
			...
			$("#doSearch").click(function(){
				...
				tableIns.reload({
					url:"${ctx}/borrow/queryAllBorrowByRid.action?"+params
				})
			});
